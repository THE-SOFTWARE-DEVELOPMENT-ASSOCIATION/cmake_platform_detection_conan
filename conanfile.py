...
class cmake_platform_detection_conan_project(ConanFile):
    name = "cmake_platform_detection"
    ...
    description = "modified `cmake_platform_detection` library"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["cmake_platform_detection"]
        ...
        #  os.path.join("base", "third_party", "cmake_platform_detection"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "cmake_platform_detection", "compat"))
